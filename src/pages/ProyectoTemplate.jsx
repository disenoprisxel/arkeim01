...
const projectsData = {
  ...
  'edificio-altamira': {
    ...
    year: '2025',
    hero: ARCH3,
    desc: 'Edificio de oficinas de uso corporativo ubicado en el sector de Altamira, Bogotá. El proyecto desarrolla una torre de mediana altura con fachada de vidrio y aluminio, optimizando la eficiencia energética mediante un sistema de protección solar integrado a la piel del edificio.',
    challenge: 'Diseñar un edificio corporativo que maximice el aprovechamiento del lote en altura, garantizando plantas libres de gran versatilidad y una fachada de alto rendimiento frente a la incidencia solar directa.',
    solution: 'Se implementó una retícula estructural de 8 x 8 m que libera la planta de columnas intermedias, combinada con una doble piel de lamas orientables que reducen la ganancia térmica sin comprometer la iluminación natural.',
    ...
    details: [
      ...
      { label: 'Año', val: '2025' },
      { label: 'Área', val: '3.200 m²' },
      { label: 'Pisos', val: '8 niveles + sótano' },
      { label: 'Estado', val: 'Diseño arquitectónico' },
      { label: 'Tipo', val: 'Comercial · Oficinas corporativas' },
    ],
    related: [
      { id: 'edificio-calle-53', title: 'Edificio We Live 53', cat: 'Comercial', img: ARCH3 },
